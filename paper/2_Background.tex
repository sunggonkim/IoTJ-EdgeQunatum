...
\begin{figure}[!t]
    ...
    \subfloat[16 Subsets.]{
        \includegraphics[width=0.48\linewidth]{Figures/16_patt.png}
        \label{16_subset}
    }
    \subfloat[64 Subsets.]{
        \includegraphics[width=0.48\linewidth]{Figures/64_patt.png}
        \label{64_subset}
    }
\vspace{-.2cm}

    % --- (3) Caption ---
    \caption{Skewed subset access pattern in 30-qubit QFT circuits on edge devices.}
    \vspace{-.3cm}
    \label{back_fsv}
\end{figure}
