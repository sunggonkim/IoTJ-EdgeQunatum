...
\midrule
20 & 0.10 & 0.09 & 8.56 & \textbf{1.02} \\
22 & 0.04 & 0.09 & 25.22 & \textbf{2.15} \\
24 & 0.03 & 0.09 & 62.66 & \textbf{4.77} \\
26 & 0.04 & 0.07 & 223.92 & \textbf{14.81} \\
28 & OOM & OOM & --- & \textbf{45.2} \\
\bottomrule
\end{tabular}
\label{tab:baselines}
\end{table}

\textbf{Speedup}: \EdgeQuantum achieves 8.4$\times$--15.1$\times$ speedup over BMQSim-like baseline by eliminating I/O wait through async prefetching and gate fusion.
