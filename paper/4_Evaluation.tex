...
\textbf{Software}: Ubuntu 20.04 (JetPack 5.1), CUDA 11.4, cuQuantum Python 23.3.0, cuStateVec 1.9.0, Python 3.8. These specific versions were selected due to the hardware-software compatibility matrix of the Orin Nano platform.
