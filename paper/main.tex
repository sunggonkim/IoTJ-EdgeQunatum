...
With this design, \EdgeQuantum partitions the full state vector into chunks, manages their residency via a 4-buffer UVM zero-copy pipeline, overlaps computation with data movement through asynchronous execution, and employs on-the-fly LZ4 compression to maximize effective storage capacity.
