%%
%% EdgeQuantum: Scalable Quantum Circuit Simulation on Resource-Constrained Edge Devices
%% (ScaleQsim-style format)
%%
...
\title{EdgeQuantum: Scalable Quantum Circuit Simulation Framework for Resource-Constrained Edge Devices}
